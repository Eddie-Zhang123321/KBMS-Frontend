...
const handleTenantRegister = async () => {
    ...
    try {
        ...
        // 捕获任何未处理的异常
        console.error('企业注册异常:', error)
        ElMessage.error('企业注册失败，请稍后重试')
    } finally {
        // 5. 关闭加载状态
